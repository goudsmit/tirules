...
6. During the action phase, if a player resolves the primary ability on the <i>Politics</i> strategy card, that player chooses any player other than the current speaker to gain the speaker token.
