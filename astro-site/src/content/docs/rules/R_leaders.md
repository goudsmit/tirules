...
### Agents
4. An agent does not need to be unlocked and begins the game in a readied state. They can be exhausted by resolving their abilities, and they ready during the <b>Ready Cards</b> step of the status phase.

### Commanders
6. A commander must be unlocked to use its abilities. A player unlocks their commander if they fulfill the conditions listed after the “Unlock” header.
...
7. A commander cannot be exhausted.
8. The <i>Alliance</i> promissory note allows a player to share their commander’s ability with another player.
 
    1. A commander’s owner can still use their commander’s ability, even if another player has their <i>Alliance</i> promissory note.


### Heroes
10. A hero needs to be unlocked to use their abilities. A player unlocks their hero if they fulfill the conditions listed after the “Unlock” header.
...
11. A hero cannot be exhausted.
12. A hero is purged after its abilities are resolved.
...
1. A commander’s ability cannot be applied to the instance of the effect that unlocked it.
2. A commander may be unlocked between two abilities that occur in the same timing window.
3. For notes about a leader of a specific faction, see that faction’s page.
