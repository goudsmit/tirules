...
1. Frontier tokens are placed on the game board during setup. One frontier token is placed in each system that does not contain any planets.
...
1. Players may explore space areas that contain frontier tokens if they own the <i>Dark Energy Tap</i> technology or if another game effect allows them to.
