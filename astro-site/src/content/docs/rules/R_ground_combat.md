...
During the <b>Ground Combat</b> step of an invasion, if the active player has ground forces on a planet that contains another player’s ground forces, those players resolve a ground combat on that planet. To resolve a ground combat, players perform the following steps:

 
1. <b>Step 1 – Roll Dice</b>: Each player rolls one die for each ground force they have on the planet; this is a combat roll. If a unit’s combat roll produces a result that is equal to or greater than that unit’s combat value, that roll produces a hit.
 
    1. If a unit’s combat value contains two or more burst icons, the player rolls one die for each burst icon instead.

2. <b>Step 2 – Assign Hits</b>: Each player in the combat must choose one of their own ground forces on the planet to be destroyed for each hit result their opponent produced.
...
3. After assigning hits, if both players still have ground forces on the planet, players resolve a new combat round starting with the <b>Roll Dice</b> step.
...
1. The “start of combat” and “start of combat round” windows occur before the <b>Roll Dice</b> step.
2. The “end of combat” and “end of combat round” windows occur after the <b>Assign Hits</b> step.
