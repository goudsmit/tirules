...
4. Players can explore space areas that contain frontier tokens if they own the <i>Dark Energy Tap</i> technology or if another game effect allows them to.
...
2. <i>Enigmatic Device</i> and <i>Ion Storm</i> are placed into play, not into the frontier discard pile.
