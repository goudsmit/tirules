...
## Sever (Promissory Note)</sub>

 
 
 
## Subatomic Splicer (Technology)</sub>
...
## Quietus (Flagship)</sub>

 
 1. The <i>Quietus</i> removes only the unit abilities from other players’ units; any text abilities are unaffected.
...
## Resonance Generator (Breakthrough)</sub>

 
 1. The passive, movement ability of <i>Resonance Generator</i> is still in effect when the card is exhausted.
